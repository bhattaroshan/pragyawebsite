...
const navigationMenuTriggerStyle = cva(
  "group/navTrig inline-flex h-9 w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-colors hover:text-primary-light-faded focus:outline-none disabled:pointer-events-none disabled:opacity-50"
)
